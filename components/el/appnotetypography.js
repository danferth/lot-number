...
const Caption = props => {
  return (
    ...
    >
      <span className="font-normal text-gray-800 italic text-xs mr-2">
        {props.fig && "fig."}
        {props.table && "table."}
        {props.fig || props.table}
      </span>
      <span className="font-extralight text-gray-600 text-xs leading-tight">
        {props.children}
      </span>
    </p>
  )
  ...
  return (
    <div css={[wrapperStyles]}>
      <table css={[tableStyles]}>
        {props.caption && (
          <caption className=" border-b border-blue-500 mb-2">
            <span className="font-normal text-gray-800 italic text-xs mr-2">{`Table.${props.caption[0]}`}</span>
            <span
              className="font-extralight text-gray-600 text-xs leading-tight"
