    ...
    >
      <div className="grid grid-cols-12 gap-x-12">
        ...
        <div className="col-span-6">
          ...
          {documentReady ? (
            <div className="bg-white rounded px-4 pt-3 pb-24">
              <div className="mb-4 bg-gray-100 px-2 pt-2 pb-1 rounded">
                  ...
                  {documentType.current.map((dt, index) => {
                    ...
                    if (
                      ...
                      return (
                        <Disclaimer
                          key={index}
                          className="pl-4 text-red-700 mt-1.5"
                        >
              ...
              {mixedLot.current && (
                <div>
                  {!containingLotsReady && (
                    <div className="bg-yellow-200 p-2.5 rounded my-4 flex items-center justify-start space-x-4">
                  ...
                  {containingLotsReady &&
                    mixedLotData.current.map((lot, index) => {
                      ...
                      return (
                        <div
                          className="mb-4 bg-gray-100 px-2 pt-2 pb-1 rounded"
                          key={index}
                        >
                          <p className="pl-4 my-0 text-gray-600 underline text-xs">
