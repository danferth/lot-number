                ...
                {isLotMixed && (
                  <div className="col-span-8">
                    {verifyResults.length > 0 && unverifiedLot && (
                      <span className="inline-block mb-2 pb-1.5 pr-8 bg-red-50 rounded">
                        <Error>
                        ...
                        return (
                          ...
                          >
                            <div className="relative w-full">
                              <Controller
                                as={<input />}
                                className="py-1 border-0 ring-1 ring-gray-300 focus:ring focus:ring-blue-200 block w-full transition sm:text-xs sm:leading-5 rounded-md shadow-sm"
                                type="text"
                            ...
                            <button
                              className="p-1.5 bg-red-100 rounded font-bold"
                              onClick={() => {
                                remove(index)
                                setVerify(0)
                                setVerifyResults([])
                            ...
                            >
                              <Xicon className="text-red-700 h-3 w-auto" />
                            </button>
                          </li>
                        )
                      })}
...
const FieldSet = props => {
  return (
    <fieldset className={props.className}>
      <h5 className="font-medium text-base mb-1.5">{props.title}</h5>
      <div className="grid grid-cols-1 gap-y-6 md:grid-cols-9 gap-x-4 md:gap-x-6">
        {props.children}
      </div>
    </fieldset>
  )
