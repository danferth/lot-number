    ...
    >
      <div className="grid grid-cols-12 gap-x-4">
        <div className="col-span-12">
          <P>
            Use the{" "}
            <PencilIcon className="inline-block w-auto h-4 text-yellow-500 fill-current" />{" "}
            <TrashIcon className="inline-block w-auto h-4 text-red-600 fill-current" />{" "}
            <InformationCircleIcon className="inline-block w-auto h-4 text-blue-500 fill-current" />{" "}
              ...
              <Tr>
                <Td colspan="4">
                  <div className="flex items-center justify-center w-full space-x-8">
                    <button
                      className="text-blue-600 underline hover:text-blue-800 hover:no-underline disabled:text-blue-400"
        ...
        {viewObj && deleteEntryInitialize && (
          <div className="col-span-12">
            <Disclaimer className="text-red-700">
              Delete Lot # {viewObj.lot_number}, this action can not be undone!
            </Disclaimer>
            <div className="flex items-center justify-start space-x-2.5 mt-4">
              <Button
                type="button"
                onClick={() => {
                  setDeleteEntryInitialize(false)
        ...
        {viewObj && editView && (
          <div className="col-span-12">
            ...
            <Disclaimer className="mt-0! mb-1.5">
                            ...
                            >
                              <div className="relative w-full">
                                <Controller
                                  ...
                                  className="pr-12 py-1 border-0 ring-1 ring-gray-300 focus:ring focus:ring-blue-200 block w-full transition sm:text-xs sm:leading-5 rounded-md shadow-sm"
                                  type="text"
                              ...
                              <button
                                type="button"
                                className="p-1.5 bg-red-100 rounded-full font-bold"
                                onClick={() => {
                                  remove(index)
                                  clearVerify()
                                }}
                              >
                                <Xicon className="text-red-700 h-3.5 w-auto" />
                              </button>
                            </li>
                          )
                        })}
...
const FieldSet = props => {
  return (
    <fieldset className={props.className}>
      <h5 className="font-medium text-sm mb-1.5">{props.title}</h5>
      <div className="grid grid-cols-1 gap-y-6 md:grid-cols-9 gap-x-4 md:gap-x-6 bg-white pt-2.5 pb-3 px-4 rounded-md">
        {props.children}
      </div>
    </fieldset>
  )
    ...
    <>
      <Tr key={props.data._id}>
        ...
        <Td className="flex items-center justify-start space-x-1.5 pr-1.5 pl-0">
          ...
          >
            <InformationCircleIcon className="w-4 h-4 fill-current" />
          </button>
        </Td>
      </Tr>
      {open && (
