...
const CertFooter = props => {
  ...
  return (
    <div tw="mt-8">
      <div tw="grid gap-y-4 md:gap-y-0 md:gap-x-6 grid-cols-1 md:grid-cols-2 print:block">
        <div tw="col-span-1 mb-8 md:mb-0 print:w-1/2 print:pr-4 print:inline-block">
          <p className="handwritten italic text-base text-gray-600 text-center">
            {props.signee}
          </p>
          <p tw="text-xs text-gray-600 text-center border-t border-gray-300 pt-1.5">
            Quality Assurance
          </p>
        </div>
        <div tw="col-span-1 flex flex-col place-content-end print:w-1/2 print:pl-4 print:inline-block">
          <p tw="italic text-sm text-gray-600 text-center">{props.signDate}</p>
          <p tw=" text-xs text-gray-600 text-center border-t border-gray-300 pt-1.5">
            Date
          </p>
        </div>
      ...
      <footer>
        <div tw="pt-8">
          <div tw="text-xs text-center space-x-8 text-gray-600">
            <span>
        ...
        <div tw="mt-1.5 text-xs text-gray-600 text-center space-x-8">
          <span>{props.id}</span>
