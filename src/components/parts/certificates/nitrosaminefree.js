...
const NitrosamineFree = props => {
  return (
    <CertWrap title="Nitrosamine Free Statement">
      <CertBody>
        <P>
          Thomson Instrument Company does not intentionally add or use
          nitrosamine during the manufacturing and packaging of the product
          indicated below,
        </P>
        ...
        <P>
          ...
          nitrosamine to be present in our final products.
        </P>
      </CertBody>
      <CertFooter
...
export default NitrosamineFree
