...
const H1 = tw.h1`text-2xl text-gray-900 border-b border-gray-900 font-extralight mt-0 mb-4 pb-2`
// const H2 = tw.h2`text-lg text-gray-800 mt-6 mb-2 font-bold`
const H3 = tw.h3`text-base text-gray-800 mt-3 mb-1 font-semibold`
const P = tw.p`text-gray-700 mb-4 text-sm`
// used in appnoteblock and productblock
const H4 = tw.h4`font-semibold text-sm text-gray-800 mb-1.5`

// elements
const Citation = tw.p`font-extralight text-gray-400 text-xs my-0 max-w-md`
const H2 = tw.p`mt-10 mb-4 font-normal font-semibold text-gray-800 max-w-md -ml-10 pl-10 pr-3 py-2.5 rounded-r-md bg-blue-200`
...
const Li = tw.li`text-sm font-normal text-gray-600 mb-2 leading-tight`
